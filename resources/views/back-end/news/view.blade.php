						...
						<div class="row align-items-center">
							<div class="col-md-12">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="javascript:">Data News</a></li>
								</ul>
							</div>
						</div>
					</div>
									...
									<div class="card-header">
										<div class="row">
											<div class="col-xl-2 col-md-2">
												<a href="{{ route('back-end.addnews') }}" class="btn theme-bg"
											...
											<table class="table table-hover text-center" id="table_id">
												...
												<tbody>
													...
													<tr class="unread">
														...
														<td>
															<img src="/foto/news/{{ $row->photo }}" width="100px">
														</td>
														<td>
														...
														<td>
															<div class="dropdown">
																...
																<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
																	...
																	href="{{ route('back-end.editnews', $row->id) }}">Edit</a>

																	<a class="dropdown-item" href="#"
																	onclick="del('{{ url('admin/news/delete', $row->id) }}')">Hapus</a>
																</div>
															</div>
														</td>
													</tr>
