						...
						<div class="row align-items-center">
							<div class="col-md-12">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="javascript:">Data Gallery</a></li>
								</ul>
							</div>
						</div>
					</div>
									...
									<div class="card-header">
										<div class="row">
											<div class="col-xl-2 col-md-2">
												<a href="{{ route('back-end.addgallery') }}" class="btn theme-bg"
											...
											<table class="table table-hover text-center" id="table_id">
												<thead>
													<tr class="unread">
														...
														<th>
															<h6 class="mb-1"><b>Foto</b></h6>
														</th>
														<th>
															<h6 class="mb-1"><b>Judul</b></h6>
														</th>
														<th>
															<h6 class="mb-1"><b>Isi</b></h6>
														</th>
														<th>
												...
												<tbody>
													...
													<tr class="unread">
														...
														<td>
															<img src="/foto/gallery/{{ $row->photo }}" width="100px">
														</td>
														<td>
														...
														<td>
															<div class="dropdown">
																...
																<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
																	...
																	href="{{ route('back-end.editgallery', $row->id) }}">Edit</a>

																	<a class="dropdown-item" href="#"
																	onclick="del('{{ url('admin/gallery/delete', $row->id) }}')">Hapus</a>
																</div>
															</div>
														</td>
													</tr>
