    ...
    <header id="header" id="home">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between d-flex">
                <div id="logo">
                    <a href="index.html"><img src="{{ asset('front-end/img/logo.png') }}" alt="" title="" /></a>
                </div>
            ...
            <div class="row">
                <div class="active-exibition-carusel">
                    <div class="single-exibition item">
                        <img src="{{ asset('front-end/img/e1.jpg') }}" alt="">
                        <ul class="tags">
                    ...
                    <div class="single-exibition item">
                        <img src="{{ asset('front-end/img/e2.jpg') }}" alt="">
                        <ul class="tags">
                            <li><a href="#">Travel</a></li>
                            <li><a href="#">Life style</a></li>
                        </ul>
                    ...
                    <div class="single-exibition item">
                        <img src="{{ asset('front-end/img/e3.jpg') }}" alt="">
                        <ul class="tags">
                            <li><a href="#">Travel</a></li>
                            <li><a href="#">Life style</a></li>
                        </ul>
                    ...
                    <div class="single-exibition item">
                        <img class="img-fluid" src="{{ asset('front-end/img/e2.jpg') }}" alt="">
                        <ul class="tags">
                            <li><a href="#">Travel</a></li>
                            <li><a href="#">Life style</a></li>
                        </ul>
                    ...
                    <div class="single-exibition item">
                        <img class="img-fluid" src="{{ asset('front-end/img/e3.jpg') }}" alt="">
                        <ul class="tags">
                            <li><a href="#">Travel</a></li>
                            <li><a href="#">Life style</a></li>
                        </ul>
            ...
            <div class="row">
                <div class="col-lg-6 event-left">
                    <div class="single-events">
                        <img class="img-fluid" src="{{ asset('front-end/img/u1.jpg') }}" alt="">
                    ...
                    <div class="single-events">
                        <img class="img-fluid" src="{{ asset('front-end/img/u3.jpg') }}" alt="">
                        <a href="#"><h4>Event on the rock solid carbon</h4></a>
                        <h6><span>21st February</span> at Central government museum</h6>
                        <p>
                            inappropriate behavior is often laughed off as “boys will be boys,” women face higher conduct standards especially.
                ...
                <div class="col-lg-6 event-right">
                    <div class="single-events">
                        ...
                        <a href="#" class="primary-btn text-uppercase">View Details</a>
                        <img class="img-fluid" src="{{ asset('front-end/img/u2.jpg') }}" alt="">
                    </div>
                    <div class="single-events">
                        ...
                        <a href="#" class="primary-btn text-uppercase">View Details</a>
                        <img class="img-fluid" src="{{ asset('front-end/img/u4.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="blog-area section-gap" id="blog">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 single-blog">
                    <div class="thumb">
                        <img class="img-fluid" src="{{ asset('front-end/img/b4.jpg') }}" alt="">
                    </div>
                    <p class="date">10 Jan 2018</p>
                    <a href="#"><h4>Addiction When Gambling
                    Becomes A Problem</h4></a>
    ...
    <section class="gallery-area section-gap" id="gallery">
        <div class="container">
            ...
            <div id="grid-container" class="row">
                <a class="single-gallery" href="img/g1.jpg"><img class="grid-item" src="{{ asset('front-end/img/g1.jpg') }}"></a>
                <a class="single-gallery" href="img/g2.jpg"><img class="grid-item" src="{{ asset('front-end/img/g2.jpg') }}"></a>
                <a class="single-gallery" href="img/g3.jpg"><img class="grid-item" src="{{ asset('front-end/img/g3.jpg') }}"></a>
                <a class="single-gallery" href="img/g4.jpg"><img class="grid-item" src="{{ asset('front-end/img/g4.jpg') }}"></a>
                <a class="single-gallery" href="img/g5.jpg"><img class="grid-item" src="{{ asset('front-end/img/g5.jpg') }}"></a>
                <a class="single-gallery" href="img/g6.jpg"><img class="grid-item" src="{{ asset('front-end/img/g6.jpg') }}"></a>
                <a class="single-gallery" href="img/g7.jpg"><img class="grid-item" src="{{ asset('front-end/img/g7.jpg') }}"></a>
                <a class="single-gallery" href="img/g8.jpg"><img class="grid-item" src="{{ asset('front-end/img/g8.jpg') }}"></a>
                <a class="single-gallery" href="img/g9.jpg"><img class="grid-item" src="{{ asset('front-end/img/g9.jpg') }}"></a>
                <a class="single-gallery" href="img/g10.jpg"><img class="grid-item" src="{{ asset('front-end/img/g10.jpg') }}"></a>
                <a class="single-gallery" href="img/g11.jpg"><img class="grid-item" src="{{ asset('front-end/img/g11.jpg') }}"></a>
                <a class="single-gallery" href="img/g12.jpg"><img class="grid-item" src="{{ asset('front-end/img/g12.jpg') }}"></a>
                <a class="single-gallery" href="img/g4.jpg"><img class="grid-item" src="{{ asset('front-end/img/g4.jpg') }}"></a>
                <a class="single-gallery" href="img/g5.jpg"><img class="grid-item" src="{{ asset('front-end/img/g5.jpg') }}"></a>
            </div>
        </div>
